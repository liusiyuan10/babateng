...
@implementation XEMallOrderThreeCell
...
-(UIView*)contentViewCell{
    ...
    UIView *bgView = [[UIView alloc]initWithFrame:CGRectMake(0,0, kDeviceWidth,118 + 16)];
    bgView.backgroundColor = [UIColor clearColor];
    
    
    UIView *backView = [[UIView alloc]initWithFrame:CGRectMake(16,16, kDeviceWidth - 32,118)];
    ...
    UIImageView *lineView = [[UIImageView alloc] initWithFrame:CGRectMake(16, CGRectGetMaxY(_freightnoLabel.frame) + 16, kDeviceWidth - 32 *2, 1.0)];
...
//    
//    
//    UIView *bgView = [[UIView alloc]initWithFrame:CGRectMake(0,0, kDeviceWidth,72 + 16)];
//    bgView.backgroundColor = [UIColor clearColor];
//    
//    
//    UIView *backView = [[UIView alloc]initWithFrame:CGRectMake(16,16, kDeviceWidth - 32,72)];
//    backView.backgroundColor = [UIColor whiteColor];
//    
//    backView.layer.cornerRadius= 15.0f;
//    
...
//    [bgView addSubview:backView];
//    
//    _totalLabel = [[UILabel alloc] initWithFrame:CGRectMake( 17, 18, 100, 11)];
//    _totalLabel.font = [UIFont systemFontOfSize:12.0];
//    _totalLabel.backgroundColor = [UIColor clearColor];
//    _totalLabel.text = @"合计";
//    _totalLabel.textColor = [UIColor colorWithRed:144/255.0 green:144/255.0  blue:144/255.0  alpha:1.0];
...
//    _totalnoLabel.font = [UIFont systemFontOfSize:15.0];
//    _totalnoLabel.backgroundColor = [UIColor clearColor];
//    _totalnoLabel.textColor = MNavBackgroundColor;
//    _totalnoLabel.textAlignment = NSTextAlignmentRight;
//    _totalnoLabel.text = @"3600see";
//    
//    [backView addSubview:_totalnoLabel];
//    
//    _rewardLabel = [[UILabel alloc] initWithFrame:CGRectMake( 17, CGRectGetMaxY(_totalLabel.frame) + 15, 100, 11)];
...
//
//    
//    _rewardnoLabel = [[UILabel alloc] initWithFrame:CGRectMake( subtitleX, CGRectGetMaxY(_totalnoLabel.frame) + 12, subtitleW, 12)];
//    
//    _rewardnoLabel.font = [UIFont systemFontOfSize:15.0];
//    _rewardnoLabel.backgroundColor = [UIColor clearColor];
//    _rewardnoLabel.textColor = MNavBackgroundColor;
//    _rewardnoLabel.textAlignment = NSTextAlignmentRight;
//    _rewardnoLabel.text = @"12.00小二币";
//    
//    [backView addSubview:_rewardnoLabel];
//    
//
