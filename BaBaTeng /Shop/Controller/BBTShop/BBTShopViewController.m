...
#import "BBTShopScrollListViewController.h"
#import "BBTShopHScrollListViewController.h"
...
@interface BBTShopViewController ()<UIScrollViewDelegate>{
...
@implementation BBTShopViewController

static BBTShopViewController *qBBTShopViewController;

+(BBTShopViewController *)getInstance{
    
    return qBBTShopViewController;
}
- (void)viewDidLoad {
    [super viewDidLoad];
    
    qBBTShopViewController = self;
...
- (void)addQController
{
    BBTShopHScrollListViewController *vc1 = [[BBTShopHScrollListViewController alloc]init];
    ...
    for (int i = 1 ; i<self.arrayCategoryList.count;i++){
        BBTShopScrollListViewController *vc1 = [[BBTShopScrollListViewController alloc]init];
...
- (void)scrollViewDidEndScrollingAnimation:(UIScrollView *)scrollView
{
    ...
    // 添加控制器
    if (index == 0) {
        BBTShopHScrollListViewController *newsVc = self.childViewControllers[index];
    ...
    {
        BBTShopScrollListViewController *newsVc = self.childViewControllers[index];
