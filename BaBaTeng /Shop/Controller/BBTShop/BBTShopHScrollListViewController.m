//
//  BBTShopHScrollListViewController.m
//  BaBaTeng
//
...
@interface BBTShopHScrollListViewController ()<UITableViewDelegate,UITableViewDataSource,NewPagedFlowViewDelegate, NewPagedFlowViewDataSource>
...
@implementation BBTShopHScrollListViewController
...
- (void)LoadChlidView
{
    ...
    CGFloat TableH = KDeviceHeight - kDevice_Is_iPhoneX -73;
