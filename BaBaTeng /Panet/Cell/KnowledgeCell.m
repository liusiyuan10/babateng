...
-(UIView*)contentViewCell{
    ...
    _noLabel = [[UILabel alloc] initWithFrame:CGRectMake(kDeviceWidth - 120  - 16, 30, 120, 12)];
    
    _noLabel.font = [UIFont boldSystemFontOfSize:15.0];
    _noLabel.backgroundColor = [UIColor clearColor];
    _noLabel.textColor = [UIColor colorWithRed:26/255.0 green:106/255.0 blue:25/255.0 alpha:1.0];
