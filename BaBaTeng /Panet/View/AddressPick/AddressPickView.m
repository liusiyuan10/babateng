...
#define pickViewViewHeight 280.0f
...
-(void)_createView
{
    ...
    _bottomView = [[UIView alloc]initWithFrame:CGRectMake(0, KDeviceHeight, kDeviceWidth, navigationViewHeight+pickViewViewHeight)];
    [self addSubview:_bottomView];
    //导航视图
    _navigationView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, kDeviceWidth, navigationViewHeight)];
    _navigationView.backgroundColor = [UIColor colorWithRed:233/255.0 green:231/255.0 blue:228/255.0 alpha:1.0];
...
//        button.frame = CGRectMake(i*(kDeviceWidth-buttonWidth), 0, buttonWidth, navigationViewHeight);
...
//    }
    ...
    cancelbutton.frame = CGRectMake(0, 0, buttonWidth, navigationViewHeight);
    [cancelbutton setTitle:@"取消" forState:UIControlStateNormal];
    cancelbutton.titleLabel.font = [UIFont systemFontOfSize:16];
    [cancelbutton setTitleColor:[UIColor colorWithRed:146/255.0 green:142/255.0 blue:139/255.0 alpha:1.0] forState:UIControlStateNormal];
    ...
    confirmbutton.frame = CGRectMake((kDeviceWidth-buttonWidth), 0, buttonWidth, navigationViewHeight);
    
    confirmbutton.titleLabel.font = [UIFont systemFontOfSize:16];
    [confirmbutton setTitleColor:[UIColor colorWithRed:255/255.0 green:127/255.0 blue:0/255.0 alpha:1.0] forState:UIControlStateNormal];
    [confirmbutton setTitle:@"确定" forState:UIControlStateNormal];
    [_navigationView addSubview:confirmbutton];
    
    confirmbutton.tag = 1;
    
    [confirmbutton addTarget:self action:@selector(tapButton:) forControlEvents:UIControlEventTouchUpInside];
    
    _pickView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, navigationViewHeight, kDeviceWidth, pickViewViewHeight)];
...
-(void)showBottomView
{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        _bottomView.top = KDeviceHeight-navigationViewHeight-pickViewViewHeight;
        self.backgroundColor = [UIColor clearColor];
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    CGFloat pickViewWidth = kDeviceWidth/3;
