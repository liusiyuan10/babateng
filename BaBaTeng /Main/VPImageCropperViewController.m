...
- (void)initControlBtn {
    ...
    UIView *container = [[UIView alloc]initWithFrame:CGRectMake(0, self.view.frame.size.height - 50.0f, self.view.frame.size.width, 50)];
    container.backgroundColor = [UIColor blackColor];
    container.alpha  = 0.5;
    [self.view addSubview:container];
     //适配iphone x
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 50.0f-kDevice_Is_iPhoneX, 100, 50)];
    ...
    [self.view addSubview:cancelBtn];
     //适配iphone x
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - 100.0f, self.view.frame.size.height - 50.0f-kDevice_Is_iPhoneX, 100, 50)];
