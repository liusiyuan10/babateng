...
- (id)initWithDelegate:(id)delegate {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"opt_01_nor.png"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"opt_01_sel.png"] forState:UIControlStateSelected];
