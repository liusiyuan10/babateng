...
@interface CZAgePickerView ()<UIPickerViewDataSource, UIPickerViewDelegate>
...
@implementation CZAgePickerView
...
- (void)initSubViews
{
    ...
    self.controllerToolBar.backgroundColor = [UIColor colorWithRed:233/255.0 green:231/255.0 blue:228/255.0 alpha:1.0];
    ...
    [self.finishBtn setTitleColor:[UIColor colorWithRed:255/255.0 green:127/255.0 blue:0/255.0 alpha:1.0] forState:UIControlStateNormal];
    ...
    [self.cancelBtn setTitleColor:[UIColor colorWithRed:146/255.0 green:142/255.0 blue:139/255.0 alpha:1.0] forState:UIControlStateNormal];
...
{
    return [NSString stringWithFormat:@"%@岁",self.dataSource[row]];
}
