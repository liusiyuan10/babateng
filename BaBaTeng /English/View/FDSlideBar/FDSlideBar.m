...
#define DEFAULT_SLIDER_COLOR [UIColor colorWithRed:250.0/255 green:165.0/255 blue:26.0/255 alpha:1.0f]
...
- (void)setupItems {
    ...
    _sliderView.frame = CGRectMake(16, self.frame.size.height - SLIDER_VIEW_HEIGHT, firstItem.frame.size.width, SLIDER_VIEW_HEIGHT);
}
