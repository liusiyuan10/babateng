...
#import "EquipmentSoundOGQNetWorkViewController.h"


@interface EquipmentSetNetworkViewController ()<UITextFieldDelegate ,QCheckBoxDelegate,AVAudioPlayerDelegate,CLLocationManagerDelegate>
{
    AppDelegate *appDele;
    BOOL hideAP;
}
...
@implementation EquipmentSetNetworkViewController
...
- (void)viewDidLoad {
    ...
    //[self.promptPicture addGestureRecognizer:singleTap];
...
//    [nextButton setImage:[UIImage imageNamed:@"soundwork"] forState:UIControlStateNormal];
//    [nextButton setImage:[UIImage imageNamed:@"soundworksel"] forState:UIControlStateSelected];
    ...
    [nextButton setTitle:@"开始声波配网" forState:UIControlStateNormal];
    
    [nextButton setTitle:@"开始声波配网" forState:UIControlStateHighlighted];
    
    [nextButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    nextButton.titleLabel.font = [UIFont systemFontOfSize:15];
    
    [nextButton addTarget:self action:@selector(soundButtonClick) forControlEvents:UIControlEventTouchUpInside];
...
//    [soundButton setTitle:@"切换WIFI配网" forState:UIControlStateNormal];
    ...
    if ([self.deivceProgramId isEqualToString:@"9"]||[self.deivceProgramId isEqualToString:@"8"]||[self.deivceProgramId isEqualToString:@"10"]||[self.deivceProgramId isEqualToString:@"11"]) {
        [soundButton setTitle:@"开始热点配网" forState:UIControlStateNormal];
    }
    else
    {
        [soundButton setTitle:@"切换WIFI配网" forState:UIControlStateNormal];
...
//    titleLabel.text = @"如多次配网失败，请选择WIFI配网";
    ...
    if ([self.deivceProgramId isEqualToString:@"9"]||[self.deivceProgramId isEqualToString:@"8"]||[self.deivceProgramId isEqualToString:@"10"]||[self.deivceProgramId isEqualToString:@"11"]) {
        titleLabel.text = @"如多次配网失败，请选择热点配网";
    }
    else
    {
        titleLabel.text = @"如多次配网失败，请选择WIFI配网";
...
//        UILabel *iv = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 80, 50)];
//        //iv.text =imageName;
...
//        leftViewBtn.frame = CGRectMake(7, 0, 80, 35);
//        [ leftViewBtn setImage:[UIImage imageNamed:@"loading02"] forState:UIControlStateNormal];
//        [ leftViewBtn setTitle:@"WiFi名称" forState:UIControlStateNormal];
//        [ leftViewBtn setTitleColor:[UIColor lightGrayColor] forState:UIControlStateNormal];
//        leftViewBtn.backgroundColor = [UIColor clearColor];
//        [leftViewBtn addTarget:self action:@selector(leftViewBtn:) forControlEvents:UIControlEventTouchUpInside];
//        [leftViewBtn setTitleEdgeInsets:UIEdgeInsetsMake(0, -leftViewBtn.imageView.size.width, 0, leftViewBtn.imageView.size.width)];
//        [leftViewBtn setImageEdgeInsets:UIEdgeInsetsMake(0, leftViewBtn.titleLabel.bounds.size.width, 0, -leftViewBtn.titleLabel.bounds.size.width)];
//        leftViewBtn.titleLabel.font = [UIFont systemFontOfSize:14];
...
//        
//        self.WiFiNamePrompt = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 60, 35)];
//        [self.WiFiNamePrompt setImage:[UIImage imageNamed:@"icon_xl01_nor"] forState:UIControlStateNormal];
//        [self.WiFiNamePrompt setImage:[UIImage imageNamed:@"icon_xl01_pre"] forState:UIControlStateHighlighted];
//        
//        UIView  *promptView=[[UIView alloc] initWithFrame:CGRectMake(0, 6, 60, 35)];
//        [self.WiFiNamePrompt addTarget:self action:@selector(WiFiNamePrompt:) forControlEvents:UIControlEventTouchUpInside];
//        [promptView addSubview:self.WiFiNamePrompt];
//        self.WiFiNameField.rightViewMode = UITextFieldViewModeAlways;
//        self.WiFiNameField.rightView = promptView;
//        
    }
...
//    [self.navigationController pushViewController:configVc animated:YES];
    ...
    if ([self.deivceProgramId isEqualToString:@"9"]||[self.deivceProgramId isEqualToString:@"8"]||[self.deivceProgramId isEqualToString:@"10"]||[self.deivceProgramId isEqualToString:@"11"]) {
        ...
        EquipmentSetHotNetworkViewController *configVc = [[EquipmentSetHotNetworkViewController alloc] init];
...
//        [appDele.wscPresenter setPassword:self.passwordField.text forSSID:[appDele.wscPresenter getCurrentSSID] isHidden:NO];
//
//        EquipmentSoundGNetWorkViewController *configVc = [[EquipmentSoundGNetWorkViewController alloc] init];
//        configVc.wifiName=self.WiFiNameField.text;
//        configVc.wifiPassword=self.passwordField.text;
//        configVc.deviceTypeName = self.deviceTypeName;
//        configVc.deviceTypeId = self.deviceTypeId;
...
//        [appDele.wscPresenter setPassword:self.passwordField.text forSSID:[appDele.wscPresenter getCurrentSSID] isHidden:NO];
//
//        EquipmentSoundConfigNetWorkViewController *configVc = [[EquipmentSoundConfigNetWorkViewController alloc] init];
//        configVc.wifiName=self.WiFiNameField.text;
//        configVc.wifiPassword=self.passwordField.text;
//        configVc.deviceTypeName = self.deviceTypeName;
//        configVc.deviceTypeId = self.deviceTypeId;
...
//
    ...
    if ([self.deivceProgramId isEqualToString:@"9"]||[self.deivceProgramId isEqualToString:@"8"]||[self.deivceProgramId isEqualToString:@"10"]||[self.deivceProgramId isEqualToString:@"11"]) {
        ...
        EquipmentSoundOGQNetWorkViewController *configVc = [[EquipmentSoundOGQNetWorkViewController alloc] init];
        configVc.wifiName=self.WiFiNameField.text;
        configVc.wifiPassword=self.passwordField.text;
        configVc.deviceTypeName = self.deviceTypeName;
        configVc.deviceTypeId = self.deviceTypeId;
