...
#import "ConfigEquipmentOnlineViewController.h"//无屏
#import "EquipmentBindingViewController.h"//有屏
...
@interface AddEquipmentViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section==0) {
        ...
        cell.leftImage.image = [UIImage imageNamed:@"img_sys"];
        
        cell.nameLabel.text =@"扫码绑定";
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        EquipmentScanBindingViewController *scanbindVc = [[EquipmentScanBindingViewController alloc] init];
        
        
        [self.navigationController pushViewController:scanbindVc animated:YES];
        ...
        if ([resultRespones.deivceProgramId isEqualToString:@"3"]) {
            
            BabyBlueViewController *configVc = [[BabyBlueViewController alloc] init];
            
            [self.navigationController pushViewController:configVc animated:YES];
            
        }
        else if([resultRespones.deivceProgramId isEqualToString:@"7"]||[resultRespones.deivceProgramId isEqualToString:@"13"])
        {
            NSLog(@"扫码绑定");
        ...
        else
        {
            ...
            ConfigEquipmentOnlineViewController *configVc = [[ConfigEquipmentOnlineViewController alloc] init];
            configVc.deviceTypeName = resultRespones.deviceTypeName;
            configVc.deviceTypeId = resultRespones.deviceTypeId;
            configVc.iconUrl =  resultRespones.iconUrl;
            configVc.deivceProgramId = resultRespones.deivceProgramId;
