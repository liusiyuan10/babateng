...
@interface EquipmentSoundConfigNetWorkViewController ()<AVAudioPlayerDelegate>{
...
@implementation EquipmentSoundConfigNetWorkViewController
...
- (void)audioPlayerDidFinishPlaying:(AVAudioPlayer *)player successfully:(BOOL)flag{
    ...
    _progressView.progress = self.playNum/7.0;
