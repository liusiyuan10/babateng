...
//    if(self)
    if(self && array.count >0)
    {
        ...
        for (int i = 0; i < [array count]; i++)
        {
            ...
            BulletinData *bulletindata = array[i];

            NSString *subStr =bulletindata.bulletinIcon; //imagestr[@"picture_url"];
//            NSString *subStr =array[i]; //imagestr[@"picture_url"];
        ...
        BulletinData *bulletindata = [array lastObject];

        NSString *subStr0 = bulletindata.bulletinIcon;
...
//        NSString *subStr0 = [array lastObject];
        ...
        BulletinData *bulletindata1 = array[0];
        NSString *subStr9 = bulletindata1.bulletinIcon;//imagestr9[@"picture_url"];
