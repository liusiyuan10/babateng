...
- (void)layoutSubviews
{
    ...
    if (isWithStrikeThrough_) {
        ...
        {
            line.frame = CGRectMake(0, (self.frame.size.height + 2) / 2, wordSize.width, 1);
        }
        else if (self.textAlignment == NSTextAlignmentCenter)
        {
            line.frame = CGRectMake((self.frame.size.width-wordSize.width)/2, (self.frame.size.height + 2) / 2, wordSize.width, 1);
        }
        else if (self.textAlignment == NSTextAlignmentRight)
        {
            line.frame = CGRectMake(self.frame.size.width-wordSize.width, (self.frame.size.height + 2) / 2, wordSize.width, 1);
        }
