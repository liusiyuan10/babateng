...
@interface XBExpiredViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation XBExpiredViewController
...
- (void)getPlatform
{
    ...
    [MineRequestTool GetAlstudyCardStatus:@"4" CardType:@"0" pageNum:[NSString stringWithFormat:@"%ld",(long)self.PageNum] success:^(LCPlatformModel * _Nonnull response) {
