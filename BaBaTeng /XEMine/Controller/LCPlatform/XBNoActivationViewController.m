//
//  XBNoActivationViewController.m
//  BaBaTeng
//
...
@interface XBNoActivationViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation XBNoActivationViewController
...
- (void)getPlatform
{
    ...
    [MineRequestTool GetAlstudyCardStatus:@"1" CardType:@"0" pageNum:[NSString stringWithFormat:@"%ld",(long)self.PageNum] success:^(LCPlatformModel * _Nonnull response) {
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.ValidityLabel.text = [NSString stringWithFormat:@"课程有效期:%@",listdata.validTime];
