//
//  XBAllLCPlatformViewController.m
//  BaBaTeng
//
...
@interface XBAllLCPlatformViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation XBAllLCPlatformViewController
...
- (void)getPlatform
{
    ...
    [MineRequestTool GetAlstudyCardType:@"0" pageNum:[NSString stringWithFormat:@"%ld",(long)self.PageNum] success:^(LCPlatformModel * _Nonnull response) {
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([listdata.cardStatus isEqualToString:@"1"]) {
        cell.platformStaueLabel.textColor = MNavBackgroundColor;
        cell.platformStaueLabel.text = @"未激活";
    ...
    {
        cell.platformStaueLabel.textColor = [UIColor colorWithRed:181/255.0 green:181/255.0 blue:181/255.0 alpha:1.0];
        cell.platformStaueLabel.text = @"已激活";
    }else if ([listdata.cardStatus isEqualToString:@"4"])
    {
        cell.platformStaueLabel.textColor = [UIColor colorWithRed:181/255.0 green:181/255.0 blue:181/255.0 alpha:1.0];
        cell.platformStaueLabel.text = @"已过期";
    }
    ...
    if ([listdata.cardStatus isEqualToString:@"1"] || [listdata.cardStatus isEqualToString:@"2"]) {
