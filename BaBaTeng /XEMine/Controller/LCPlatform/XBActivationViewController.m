...
@interface XBActivationViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation XBActivationViewController
...
- (void)getPlatform
{
    ...
    [MineRequestTool GetAlstudyCardStatus:@"3" CardType:@"0" pageNum:[NSString stringWithFormat:@"%ld",(long)self.PageNum] success:^(LCPlatformModel * _Nonnull response) {
