...
@implementation BBTOrderDetailNoShopCell
...
-(UIView*)contentViewCell{
    ...
    UIView *bgView = [[UIView alloc]initWithFrame:CGRectMake(0,0, kDeviceWidth,115 + 16 + 16)];
    bgView.backgroundColor = [UIColor clearColor];
    
    
    UIView *backView = [[UIView alloc]initWithFrame:CGRectMake(16,16, kDeviceWidth - 32,115)];
    ...
    UIImageView *lineView = [[UIImageView alloc] initWithFrame:CGRectMake(16, CGRectGetMaxY(freightLabel.frame) + 16, kDeviceWidth - 32 *2, 1.0)];
    
    lineView.backgroundColor = [UIColor colorWithRed:238/255.0 green:238/255.0 blue:238/255.0 alpha:1.0];
    
    [backView addSubview:lineView];
    
    _rewardLabel = [[UILabel alloc] initWithFrame:CGRectMake( kDeviceWidth - 32 - 80 - 50 - 20, CGRectGetMaxY(lineView.frame) + 17, 50, 11)];
    ...
    _rewardnoLabel = [[UILabel alloc] initWithFrame:CGRectMake( kDeviceWidth - 32 - 80-20 , CGRectGetMaxY(lineView.frame) + 15, 80, 15)];
