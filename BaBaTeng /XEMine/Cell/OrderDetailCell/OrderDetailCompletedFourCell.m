//
//  OrderDetailCompletedFourCell.m
//  BaBaTeng
//
...
@implementation OrderDetailCompletedFourCell
...
-(UIView*)contentViewCell{
    ...
    UIView *bgView = [[UIView alloc]initWithFrame:CGRectMake(0,0, kDeviceWidth,96 + 16)];
    bgView.backgroundColor = [UIColor clearColor];
    
    CGFloat backViewW = kDeviceWidth - 32;
    UIView *backView = [[UIView alloc]initWithFrame:CGRectMake(16,16, kDeviceWidth - 32,96)];
    ...
    _confirmLabel = [[UILabel alloc] initWithFrame:CGRectMake( 17, CGRectGetMaxY(_deliverytimeLabel.frame) + 6,backViewW - 17, 12)];
    
    _confirmLabel.font = [UIFont systemFontOfSize:12.0];
    _confirmLabel.backgroundColor = [UIColor clearColor];
    _confirmLabel.textColor = [UIColor colorWithRed:114/255.0 green:114/255.0 blue:114/255.0 alpha:1.0];
    _confirmLabel.text = @"确认收货：2018-10-30 15:55:33";
    _confirmLabel.textAlignment = NSTextAlignmentLeft;
    
    [backView addSubview:_confirmLabel];
