...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _field.backgroundColor=[UIColor colorWithRed:227/255.0 green:227/255.0 blue:227/255.0 alpha:1.0];
        _field.textAlignment=NSTextAlignmentLeft;
        _field.textColor=[UIColor colorWithRed:54/255.0 green:54/255.0 blue:54/255.0 alpha:1.0];
        //    self.userwalletField.text = [NSString stringWithFormat:@"%ld",(long)self.ordercount];
        ...
        _field.clipsToBounds = YES;//去除_iocnView
        _field.layer.masksToBounds = YES;
    
        _field.placeholder = @"请选择到账时间";
