...
@class AoliSegmentTool;

@protocol AoliSegmentToolCellDelegate <NSObject>
...
@interface AoliSegmentTool : UIView

@property (nonatomic, weak)id<AoliSegmentToolCellDelegate>delegate;
