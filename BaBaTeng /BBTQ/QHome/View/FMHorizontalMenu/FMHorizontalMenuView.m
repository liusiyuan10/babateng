...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.menuTile.textColor = [UIColor colorWithRed:116 / 255.0 green:116 / 255.0 blue:116 / 255.0 alpha:1.0];
...
-(void)setUpPageControl
{
    ...
    CGRect pageControlFrame = CGRectMake(x, y - 16, size.width, size.height);
...
- (FMHorizontalMenuViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(iconSizeForHorizontalMenuView:)]) {
        ...
        cell.menuIcon.layer.cornerRadius = imageSize.height/2.0;
