...
@protocol  SearchSliderLineViewDelegate <NSObject>

@required

-(void)SearchsliderViewAndReloadData:(NSInteger)index;

@end

@interface SearchTapSliderScrollView : UIView

@property (nonatomic,strong)    UIScrollView *pageScrollView;

@property (nonatomic,weak)id <SearchSliderLineViewDelegate> delegate;
