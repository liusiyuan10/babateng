...
@interface QAlbumPlayViewController ()<QSegmentToolCellDelegate,UITableViewDelegate,UITableViewDataSource,QAlbumListCellDelegate,UIGestureRecognizerDelegate,QAlbumDetailViewDelegate,QPlayListViewDelegate,MusicPlayerViewDelegate>{
...
@implementation QAlbumPlayViewController
...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(PlayDemandAlbum:) name:@"PlayDemandAlbum" object:nil];
    
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(PlayDemandAlbumPlay:) name:@"PlayDemandAlbumPlay" object:nil];
...
- (void)PlayDemandAlbumPlay:(NSNotification *)noti
{
...
- (void)PlayDemandAlbum:(NSNotification *)noti
{
...
- (void)LoadChlidView
{
    ...
    self.button .frame = CGRectMake(kDeviceWidth / 2 - 30, KDeviceHeight- 55 - 64, 50, 50);
