...
-(UIView*)contentViewCell{
    ...
    _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_myImageView.frame) + 8, 16, kDeviceWidth -CGRectGetMaxX(_leftImage.frame) - 21  - 40-20, 16)];
