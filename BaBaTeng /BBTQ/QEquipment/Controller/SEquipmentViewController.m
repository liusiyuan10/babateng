...
@interface SEquipmentViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation SEquipmentViewController
...
- (void)viewDidLoad {
    ...
    self.titleArray  = [NSMutableArray arrayWithObjects:@"设备名称",@"剩余电量",@"识别号",@"公司信息",@"解除绑定",nil];
    self.arraydata  = [NSMutableArray arrayWithObjects:@"小豚",@"20%",@"00000000001", @"",@"",nil];
    self.iconArray  = [NSMutableArray arrayWithObjects:@"icon_sbmc",@"icon_sydl",@"icon_xxzx",  @"icon_gsxx",@"icon_guanyu",nil];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 4) {
        ...
        __block SEquipmentViewController *self_c = self;
        //点击按钮回调方法
