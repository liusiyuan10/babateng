//
//  SEquipmentViewController.m
//  BaBaTeng
//
//  Created by 柳思源 on 2018/11/29.
...
@interface SCEquipmentViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation SCEquipmentViewController
...
- (void)viewDidLoad {
    ...
    self.titleArray  = [NSMutableArray arrayWithObjects:@"设备名称",@"剩余电量",@"识别号",@"当前版本",@"公司信息",@"解除绑定",nil];
    self.arraydata  = [NSMutableArray arrayWithObjects:@"小豚",@"20%",@"00000000001",@"V1.0", @"",@"",nil];
    self.iconArray  = [NSMutableArray arrayWithObjects:@"icon_sbmc",@"icon_sydl",@"icon_xxzx", @"icon_dqbb", @"icon_gsxx",@"icon_guanyu",nil];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 5) {
        ...
        __block SCEquipmentViewController *self_c = self;
        //点击按钮回调方法
