...
@interface QCategoryView()<UITableViewDelegate,UITableViewDataSource>
{
    UIView *_contentView;
}
...
//        self.alpha = 1.0;
//        
//        [_contentView setFrame:CGRectMake(0, KDeviceHeight / 2.0 - 64- 40, kDeviceWidth, KDeviceHeight / 2.0)];
//        
//    } completion:nil];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([self.delegate respondsToSelector:@selector(QCategoryViewAddBtnClicked:selectModel:)]) {
        
        
        //        [self.delegate Q3PlayListViewAddBtnClicked:self sectionIndex:listresponse.id ListTitle:listresponse.name];
        
        [self.delegate QCategoryViewAddBtnClicked:self selectModel:listresponse];
