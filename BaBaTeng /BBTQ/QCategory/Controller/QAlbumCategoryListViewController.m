//
//  QAlbumCategoryListViewController.m
//  BaBaTeng
//
...
@interface QAlbumCategoryListViewController ()<UIScrollViewDelegate>{
...
@implementation QAlbumCategoryListViewController
...
- (void)addController
{
    for (int i=0 ; i<self.arrayCategoryList.count;i++){
        QAlbumCategoryScrollListViewController *vc1 = [[QAlbumCategoryScrollListViewController alloc]init];
...
- (void)scrollViewDidEndScrollingAnimation:(UIScrollView *)scrollView
{
    ...
    // 添加控制器
    QAlbumCategoryScrollListViewController *newsVc = self.childViewControllers[index];
    newsVc.index = index;
