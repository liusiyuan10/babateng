...
-(void)setBlockOnDisconnect:(void (^)(CBCentralManager *central,CBPeripheral *peripheral,NSError *error))block{
    NSLog(@"1234454656dfsdfsdfsdfsddd");
...
//        UIAlertView *WXinstall=[[UIAlertView alloc]initWithTitle:@"" message:@"打开蓝牙来允许巴巴腾连接到配件" delegate:self cancelButtonTitle:@"设置" otherButtonTitles:@"好", nil];//一般在if判断中加入
//
//        [WXinstall show];
...
//        }
//        //                 NSLog(@"你点击了取消");
//    }else if ([btnTitle isEqualToString:@"好"] ) {
//        
//        
//    }
//}
