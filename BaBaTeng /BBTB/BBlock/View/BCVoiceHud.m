...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _images                   = @[
                                      [UIImage imageNamed:@"BBTBVoice_1"],
                                      [UIImage imageNamed:@"BBTBVoice_2"],
                                      [UIImage imageNamed:@"BBTBVoice_3"],
                                      [UIImage imageNamed:@"BBTBVoice_4"],
                                      [UIImage imageNamed:@"BBTBVoice_5"],
                                      [UIImage imageNamed:@"BBTBVoice_6"]
                                      ];
        
//    self.animationImages = @[_images[0],_images[1],_images[2],_images[3],_images[4],_images[5]];
    }
    return self;
}
