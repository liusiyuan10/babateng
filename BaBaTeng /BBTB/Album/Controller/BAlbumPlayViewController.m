...
@interface BAlbumPlayViewController ()<QSegmentToolCellDelegate,UITableViewDelegate,UITableViewDataSource,QAlbumListCellDelegate,UIGestureRecognizerDelegate,QAlbumDetailViewDelegate,QPlayListViewDelegate>
...
@implementation BAlbumPlayViewController
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString *CellIdentifier = @"qalbumplaylistcell";
