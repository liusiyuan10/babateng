...
@interface BSongViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation BSongViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    BSongListViewController *songListVc = [[BSongListViewController alloc]init];
